          ...
          {showBox1 && (
            <MDBAnimation reveal type="slideInLeft" duration="2s">
              <div className="custom-text-sec4">
                ...
                Argo som er en affaldsvirksomhed der håndtere skrald, 
                har generelt en udfordring med at alt for mange genstande bliver afleveret på deres genbrugspladser i god stand, 
                og dertil er Argo interesseret i at få spredt genbrugstanken blandt borgerne i samfundet, så livsaldrene på genstande bliver forlænget længst muligt.
          ...
          {showBox2 && (
            <MDBAnimation reveal type="fadeIn" duration="1s">
              <div className="custom-text-sec4">
                ...
                For at finde en løsning, så stillede Argo udfordringen til COCONF 2020 via Corolab. 
                COCONF (Co-Conference) er en innovativ konference, som samler forskellige udfordringer fra deres medlemmer, 
                hvor der så pitches forskellige løsningsforslag til disse udfordringer.
          ...
          {showBox3 && (
            <MDBAnimation reveal type="fadeIn" duration="1s">
              <div className="custom-text-sec4">
                ...
                Løsningen til Argos udfordring, blev fundet af 2 studerende på datamatikeruddannelsen fra Zealand i Roskilde, 
                som omhandlede at lave et elektronisk spil målrettet børn, 
                og ideen var at hvis man kunne påvirke børn så var der et større potentiale for at få påvirket andre, 
                da børn har både mulighed for at påvirke deres venner og deres familie.
