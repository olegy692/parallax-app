          ...
          {showBox1 && (
            <MDBAnimation reveal type="slideInLeft" duration="2s">
              <div className="custom-text-sec4">
                <h1>
                  <img src={ZealandLogo} style={{ height: '40px' }}>
                  </img>
                </h1>
                ...
                <div style={{ height: '55px', display: 'flex', flexDirection: 'row', flexWrap: 'wrap', width: '100%', paddingTop: '8px', justifyContent: 'flex-end' }}>
                  <FontAwesomeIcon icon={faCircleChevronRight} className="prevNextIcons" onClick={handleNext1Click} />
                </div>
              </div>
            </MDBAnimation>
          )}
        ...
        <div className='column2' >
          {showBox2 && (
            <MDBAnimation reveal type="fadeIn" duration="1s">
              <div className="custom-text-sec4">
                <h1>
                  <img src={Corolab} style={{ height: '50px' }} />
                </h1>
                <div className="text-area-sec4">Co ro la B</div>
                <div style={{ height: '55px', display: 'flex', flexDirection: 'row', flexWrap: 'wrap', width: '100%', paddingTop: '8px', justifyContent: 'flex-end' }}>
                  <FontAwesomeIcon icon={faCircleChevronRight} className="prevNextIcons" onClick={handleNext2Click} />
                </div>
              </div>
            </MDBAnimation>
          )}
